...
function Formulario() {
  ...
  const enviarDatos = async (e) => {
    ...
    const url = 'https://script.google.com/macros/s/AKfycby0lYUZjqGA_eS9H6mpgqR_KrTuKa1e66IRwqZmsuU9aZqWp2teFDTsSbEKAMFtiQ620Q/exec';
      ...
      <div style={{ 
        ...
        <form onSubmit={enviarDatos}>
          ...
          <div style={{ 
            ...
            <h3 style={{ color: '#d32f2f', marginTop: 0, fontSize: isMobile ? '1.1em' : '1.3em' }}>🥅 ESTADISTICAS PORTEROS</h3>
